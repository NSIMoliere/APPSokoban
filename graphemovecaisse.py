...
class GMC :
    ...
    def __init__(self, level, pos):
        ...
        self.buildgrapheMC() # construction du grapheMC des mouvement possibles et du graphe des mouvements inverse possibles
        self.update(level)
        self.deadEnd()
        
    def deadEnd(self):  
        """
        Cette méthode crée un tableau de case depuis lesquels une caisse n'au aucune chance d'atteindre un jour la cible
        """
    ...
    def buildgrapheMC(self):
        """
        La fonction construit le grapheMC des mouvement de caisses possibles.
